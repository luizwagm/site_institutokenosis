/* ==========================================================================
   ...
   O sistema usava `node:sqlite`, o driver que o Node traz de fábrica. Ele
   ...
   isso derrubaria a clínica inteira.
   ...
   sem `npm install`, por exemplo), o sistema NÃO para — volta para o driver de
...
try {
  ...
  DRIVER_AVISO = "driver experimental do Node — rode `npm install` para usar o better-sqlite3";
}

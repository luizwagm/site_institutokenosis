...
#      mkdir -p ~/bin && cp ci/entregar.sh ~/bin/entregar-kenosis
#      chmod 755 ~/bin/entregar-kenosis
#
#  E no ~/.ssh/authorized_keys, a chave da entrega entra assim:
#      restrict,command="/home/deploy/bin/entregar-kenosis" ssh-ed25519 AAAA... entrega-kenosis
#
...
PROJETO="/var/www/projetos/Instituto-Kenosis"
TRAVA="/tmp/entregar-kenosis.lock"
...
logger -t entrega-kenosis "pedido de entrega de ${SSH_CLIENT%% *}"
...
logger -t entrega-kenosis "entrega terminou com código $CODIGO"
exit $CODIGO
